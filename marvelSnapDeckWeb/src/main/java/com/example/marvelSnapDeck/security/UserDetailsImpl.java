 ...
 * long serialVersionUID = 1L; private String username; private String password;
 ...
 * ArrayList<SimpleGrantedAuthority>(); for (Userrole r : roles) {
 * authorities.add(new SimpleGrantedAuthority("ROLE_" + r.getNaziv())); } return
 * authorities; }
 * 
